...
Moto2 = Motorcycle('D 1203 ABC', 'Suzuki', '2023', 'Abu  ', 'Sport Bike', '13.5 L')
...
Moto6 = Motorcycle('A 1204 LIP', 'Vespa', '2020', 'Hijau', 'Vespa', '10.5 L')
...
jumlah1 = ParkingLot('20', '6')
jumlah2 = ParkingLot('20', '4')
jumlah3 = ParkingLot('20', '5')
jumlah = ParkingLot('60', '15')
...
print('Garage Kosong yang Tersedia :')
i = 1
...
for Car in Garage1.get_carList():
    print('-', Car.getplatNomor(), '|', Car.gettahunProduksi(), '|', Car.getwarna(), '|', Car.getmerk())
...
for Motorcycle in Garage1.get_motorcycleList():
    print('-', Motorcycle.getplatNomor(), '|', Motorcycle.gettahunProduksi(), '|', Motorcycle.getwarna(), '|', Motorcycle.getmerk())
